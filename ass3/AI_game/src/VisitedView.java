...
public class VisitedView {
	...
	public ArrayList<Integer[]> getStonePut() {
		return this.stoneput;
	}
	...
	private ArrayList<Integer[]> stoneput = new ArrayList<Integer[]>();
...
//			  	boolean used = false;
//			  	for(int i = 0; i < this.stoneput.size(); i++) {
//			  		Integer[] pos = this.stoneput.get(i);
